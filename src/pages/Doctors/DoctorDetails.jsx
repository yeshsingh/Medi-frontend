                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <h3 className="text-headingColor text-[22xpx] leading-9 mt-3 font-bold">
                                    Yesh Singh
                                </h3>
                                <div className="flex items-cemter gap-[6px]">
                                ...
                                <p className="text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                                    Loreum ipsumdolor sit amet consectetur adipusicing elit.
                                    Dicta,alias!
                                </p>
                            </div>
                        </div>
