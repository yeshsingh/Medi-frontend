              ...
              {data.isApproved === "pending" && ( 
                <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 3a1 1 0 011 1v5a1 1 0 11-2 0V4a1 1 0 011-1zm0 12a1 1 0 100-2 1 1 0 000 2zm9-8a8 8 0 11-16 0 8 8 0 0116 0zM3 10a1 1 0 112 0 1 1 0 01-2 0zm1-5a1 1 0 100 2 1 1 0 000-2zm12 0a1 1 0 100 2 1 1 0 000-2zM5 15a1 1 0 100 2 1 1 0 000-2zm10 0a1 1 0 100 2 1 1 0 000-2z"
                      clipRule="evenodd"
                    ></path>
                  </svg>
